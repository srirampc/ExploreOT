        ...
        do
            ...
            do
                ...
                do
                    ...
                    filepath="./pickle_compare/${graph}/sampled_gromov_sliced/${filename}"
                    if [ ! -e $filepath ]
                    then
                        echo $filepath
                        sbatch -J $jobname --mem-per-cpu=2G sampled_gromov_sliced.sbatch $num $loss $graph $batchsize $iter
                    fi
                done
            done
        done
        ...
        do
            ...
            do
                ...
                do
                    ...
                    then
                        echo $filepath
                        sbatch -J $jobname --mem-per-cpu=4G sampled_gromov_sliced.sbatch $num $loss $graph $batchsize $iter
                    fi
                done
            done
        done
