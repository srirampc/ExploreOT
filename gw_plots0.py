...
def hyperparameter_analysis_0(n_samples_s=500,
...
def hyperparameter_analysis_3_0(n_samples_s=500,
                              name_dataset="gaussian",
                              pickle_path="pickle_compare",
                              names_algo=["sampled_gromov"],
                              names_algo_legend=["sampled_gromov"],
...
def analyse_data_hyper_0(name_dataset="gaussian",
                       pickle_path="pickle_compare",
                       names_algo=["sampled_gromov"],
                       names_algo_legend=["sampled_gromov"],
                       pickle_name="",
...
def analyse_data_0(name_dataset="gaussian",
                 pickle_path="pickle_compare",
                 names_algo=["sampled_gromov"],
                 names_algo_legend=["sampled_gromov"],
                 pickle_name="",
